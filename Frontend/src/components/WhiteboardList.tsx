...
const WhiteboardList = (props: WhiteboardListProps): React.JSX.Element => {
  switch (props.status) {
    case 'error':
    {
        ...
        return (
          <div>
            <p className="text-lg text-h3-text font-bold text-red m-12 ml-70">
              Error: {message}
            </p>
          </div>
        );
    ...
    case 'loading':
    {
        return (
          <div>
            <p className="text-lg text-h3-text font-bold m-12 ml-70 flex space-x-2">
    ...
    case 'ready':
    {
        ...
        if (whiteboardsAttribs.length < 1) {
          return (
            <p className="ml-70 pb-10 text-lg font-bold font-arial text-h3-text italic">
